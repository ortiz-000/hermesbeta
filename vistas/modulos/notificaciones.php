          ...
          <div class="card-body p-0">
            <div class="mailbox-controls">
              <div class="table-responsive mailbox-messages">
                <div class="d-flex justify-content-between align-items-center mb-2 p-2 bg-light border-bottom">
                  <div class="btn-toolbar" role="toolbar">
                    <!-- Check all button -->
                    <button type="button" class="btn btn-default btn-sm checkbox-toggle me-2">
                      <i class="far fa-square"></i> Seleccionar todo
                    </button>
                ...
                <table class="table table-hover table-striped" id="tblNotificaciones">
                  <thead>
                    <tr>
                      ...
                      <th style="width: 10px"><i class="fas fa-bell"></i></th>
