<head>
    ...
    <script>
        const usuarioActual = {
            ...
            rol: "<?php echo $_SESSION['nombre_rol']; ?>"
        };
    </script>
</head>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="input-group ">
                                                    ...
                                                    <input type="text" class="form-control" name="nombreSolicitante"
                                                        id="nombreSolicitante" placeholder="Nombre solicitante"
                                                        readonly>
                                                </div>
                                                ...
                                                <div class="ficha-d d-none">
                                                    <div class="input-group ">
                                                        ...
                                                        <input type="text" class="form-control" name="fichaSolicitante"
                                                            id="fichaSolicitante" placeholder="Ficha Solicitante"
                                                            readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control float-right"
                                                            id="initialDate" name="fechaInicio"
                                                            value="<?php echo $hoy; ?>">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control float-right"
                                                            id="finalDate" name="fechaFin" value="<?php echo $hoy; ?>">
                                                    </div>
                                                    <!-- /.input group -->
                                                </div>
                                                <!-- /.form group -->
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <textarea class="form-control" id="motivoSolicitud"
                                                        rows="3"></textarea>
                                                </div>
                                            </div>
                                        </div>
