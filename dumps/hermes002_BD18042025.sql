...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-04-2025 a las 22:16:44
...
CREATE TABLE `equipos` (
  ...
  `estado` enum('activo','inactivo','mantenimiento','baja') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `equipos` (`equipo_id`, `numero_serie`, `etiqueta`, `descripcion`, `fecha_entrada`, `ubicacion_id`, `categoria`, `cuentadante_id`, `a_cuentadante`, `estado`) VALUES
(7, 'NS-001', 'Laptop-001', 'Laptop Dell Latitude', '2024-04-01', 1, 'Computador', 1, 'Área TI', 'activo'),
(8, 'NS-002', 'Printer-001', 'Impresora HP LaserJet', '2024-04-05', 2, 'Video beam', 42, 'Área Administrativa', 'mantenimiento'),
(9, 'NS-003', 'Proyector-001', 'Proyector Epson X300', '2024-04-10', 2, 'Cable hdmi', 43, 'Área de Formación', 'inactivo');
...
(1, 1, '2025-03-22 21:35:28'),
(1, 2, '2025-03-22 21:35:28'),
(1, 3, '2025-03-22 21:35:28'),
(1, 4, '2025-03-22 21:35:28'),
(1, 5, '2025-03-22 21:35:28'),
(1, 6, '2025-03-22 21:35:28'),
(1, 7, '2025-03-22 21:35:28'),
(1, 8, '2025-03-22 21:35:28'),
(1, 9, '2025-03-22 21:35:28'),
(1, 10, '2025-03-22 21:35:28'),
(1, 11, '2025-03-22 21:35:28'),
(1, 12, '2025-03-22 21:35:28'),
(1, 13, '2025-03-22 21:35:28'),
(1, 14, '2025-03-22 21:35:28'),
(1, 15, '2025-03-22 21:35:28'),
(1, 16, '2025-03-22 21:35:28'),
(1, 17, '2025-03-22 21:35:28'),
(1, 18, '2025-03-22 21:35:28'),
(1, 19, '2025-03-22 21:35:28'),
(1, 20, '2025-03-22 21:35:28'),
(1, 21, '2025-03-22 21:35:28'),
...
(9, 1, '2025-04-16 22:04:20'),
(9, 2, '2025-04-16 22:04:20'),
(9, 3, '2025-04-16 22:04:20'),
(9, 4, '2025-04-16 22:04:20'),
(9, 5, '2025-04-16 22:04:20'),
(9, 6, '2025-04-16 22:04:20'),
(9, 7, '2025-04-16 22:04:20'),
(9, 8, '2025-04-16 22:04:20'),
(9, 9, '2025-04-16 22:04:20'),
(9, 10, '2025-04-16 22:04:20'),
(9, 11, '2025-04-16 22:04:20'),
(9, 12, '2025-04-16 22:04:20'),
(9, 13, '2025-04-16 22:04:20'),
(9, 14, '2025-04-16 22:04:20'),
(9, 15, '2025-04-16 22:04:20'),
(9, 16, '2025-04-16 22:04:20'),
(9, 17, '2025-04-16 22:04:20'),
(9, 18, '2025-04-16 22:04:20'),
(9, 19, '2025-04-16 22:04:20'),
(9, 20, '2025-04-16 22:04:20'),
(9, 21, '2025-04-16 22:04:20'),
(9, 22, '2025-04-16 22:04:20'),
(9, 23, '2025-04-16 22:04:20'),
(9, 24, '2025-04-16 22:04:20'),
...
(1, 'Bodega Principal', 'Almacen de equipos', 1),
(2, 'Sala de Computo', 'Ubicación de los equipos de cómputo', 1);
...
ALTER TABLE `equipos`
  ...
  ADD KEY `fk_equipos_cuentadante` (`cuentadante_id`);
...
--
ALTER TABLE `equipos`
  ADD CONSTRAINT `equipos_ibfk_1` FOREIGN KEY (`ubicacion_id`) REFERENCES `ubicaciones` (`ubicacion_id`),
  ADD CONSTRAINT `fk_equipos_cuentadante` FOREIGN KEY (`cuentadante_id`) REFERENCES `usuarios` (`id_usuario`);
